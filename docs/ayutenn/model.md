...
このドキュメントでは、skeletonプロジェクトでのモデルファイル(バリデーションルール定義)の作成方法を説明します。

## フレームワークリファレンス

バリデーションの詳細な仕様については、ayutenn-coreのドキュメントを参照してください：

- **[validation.md](../../vendor/tyaunen/ayutenn-core/docs/validation.md)** - バリデーションシステムの詳細仕様
