...
このドキュメントでは、PHPUnitによるユニットテストとインテグレーションテストの実装方法を説明します。

## フレームワークリファレンス

テストで使用するRedirectクラスのテストモード詳細：
- **[utils.md](../../vendor/tyaunen/ayutenn-core/docs/utils.md)** - Redirect::$isTest の仕様
