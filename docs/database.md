...
if ($result->isSucceed()) {
    ...
    AlertsSession::putAlertMessageIntoSession($error_message);
    // ...
}
```
...
{
    public static function name(): string { return 'user_register'; }
    ...
    protected string $redirectUrl = '/register-complete';
